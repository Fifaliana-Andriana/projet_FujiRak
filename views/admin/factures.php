<div class="page-header mb-4">
    ...
    <p class="text-muted mb-0">Envoie un document (facture, relevé...) à un utilisateur : PDF, DOC, DOCX, XLS ou XLSX
        (10 Mo max).</p>
</div>
...
<div class="row g-4">
    ...
    <div class="col-lg-4">
        <div class="card shadow-sm">
            <div class="card-header bg-white text-center">
                <h5 class="mb-0">Envoyer un document</h5>
            </div>
            <div class="card-body">
                <form action="index.php?route=admin/factures/upload" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="user_id" class="form-select" required>
                            ...
                            <?php foreach ($users as $u): ?>
                                <option value="<?= $u['id'] ?>"><?= htmlspecialchars($u['username']) ?>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="description" class="form-control"
                            placeholder="ex: Facture juillet 2026">
                    </div>
    ...
    <div class="col-lg-8">
        <div class="card shadow-sm">
            <div class="card-header bg-white text-center">
                <h5 class="mb-0">Documents envoyés</h5>
            </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php if (empty($factures)): ?>
                            <tr>
                                <td colspan="6" class="text-center text-muted py-4">Aucun document envoyé pour le moment.
                                </td>
                            </tr>
                        <?php else: ?>
                            <?php foreach ($factures as $f): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <i
                                            class="bi bi-file-earmark-<?= $f['file_type'] === 'pdf' ? 'pdf' : (in_array($f['file_type'], ['xls', 'xlsx']) ? 'excel' : 'word') ?>"></i>
